...
app.controller('controller', ['$scope', 'service',
    function ($scope, service) {
        ...
        $scope.jugador1 = service.crearJugador("jugador1", "jugador1", "ala", "88", "98");
        $scope.jugador2 = service.crearJugador("jugador2", "jugador2", "lateral", "3", "55");
        ...
        $scope.crearJugador = function (equipoSel) {
            ...
            if(editar){
                service.updateJugador(equipoSel, $scope.nick, $scope.nombreJug, $scope.funcion, $scope.puntos, $scope.minutos);
            }else{
                service.crearJugadorEquipo(equipoSel, $scope.nick, $scope.nombreJug, $scope.funcion, $scope.puntos, $scope.minutos);
            }
            $scope.nick=""; $scope.nombreJug=""; $scope.funcion=""; $scope.puntos=""; $scope.minutos="";
        }
        ...
        $scope.llenarFormulario = function (equipo, jugador) {
            ...
            $scope.minutos = $scope.jugador.minutosJugados; 
        }
